...
import { ArrowLeft, Send, Briefcase, Info } from "lucide-react"
...
export default function NewProjectPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        title: "Projek Berjaya Didaftar",
        description: `Projek ${formData.name} telah didaftarkan ke dalam sistem.`,
      })
  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl mx-auto space-y-8 animate-in slide-in-from-bottom-4 duration-500">
      <header className="space-y-4">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-bold font-headline text-foreground">Register New Project</h1>
          <p className="text-sm text-muted-foreground mt-1">Daftarkan portfolio projek baru ke dalam pangkalan data SPI.</p>
        </div>
      </header>
        ...
        <Card className="bg-card border-border shadow-2xl overflow-hidden">
          ...
          <CardContent className="p-6 space-y-6">
            <div className="space-y-2">
              ...
              <Input 
                id="name"
                placeholder="e.g. Projek Smart City Kajang"
                value={formData.name}
            ...
            <div className="space-y-2">
              ...
              <Select defaultValue="ACTIVE" onValueChange={(val: any) => setFormData({...formData, status: val})}>
            ...
            <div className="space-y-2">
              ...
              <Textarea 
                ...
                placeholder="Explain the project objective and main deliverables..." 
            ...
            <div className="p-4 rounded-xl bg-accent/5 border border-accent/20 flex items-start gap-3">
              ...
              <p className="text-[10px] text-muted-foreground leading-relaxed">
                Pendaftaran projek baru akan membolehkan kakitangan membuat log pergerakan (Movement) dan tiket bantuan (Tickets) berkaitan projek ini.
              </p>
            </div>
          </CardContent>
          <CardFooter className="bg-secondary/10 border-t border-border p-6 flex flex-col md:flex-row justify-between gap-4">
            <Button type="button" variant="outline" onClick={() => router.push("/projects")} className="w-full md:flex-1">
              Cancel
            </Button>
            <Button type="submit" disabled={isSubmitting} className="w-full md:flex-1 bg-primary hover:bg-primary/90 text-white font-bold gap-2">
              ...
              {isSubmitting ? "Processing..." : "Register Project"}
            </Button>
          </CardFooter>
        </Card>
      </form>
